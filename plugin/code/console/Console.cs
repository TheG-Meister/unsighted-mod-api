...
namespace dev.gmeister.unsighted.modloader.code.console;
...
public class Console : ILogListener
{
    ...
    private ConfigEntry<KeyCode> consoleHotkey;

    public Console(ConfigFile config)
    {
        this.enable = config.Bind("Console", "Enable", false, "Opens the developer console");
        //this.consoleHotkey = config.Bind("Console", "Hotkey", KeyCode.None, "The hotkey to open and close the console");
